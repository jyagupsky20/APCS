 ...
 * The Mysterion method partitions a subarray using a pivot element so that every element to the left of the pivot is less than the pivot, and so that every element to the right of the pivot is greater than or equal to the pivot.
 * <p>
...
public class Partition
{
  ...
  //remove pivot parameter
  public static int partitionQ(int[] arr, int loPos, int hiPos){
    return partition(arr, loPos, hiPos, loPos);
  }
